...
module.exports = {
  ...
  output: {
    path: path.join(__dirname, 'twitter_python_mentors', 'static', 'build'),
  ...
  plugins: [
    ...
    new ManifestRevisionPlugin(path.join(__dirname, 'twitter_python_mentors', 'webpack', 'manifest.json'), {
      rootAssetPath,
      ignorePaths: ['/js', '/css'],
    }),
  ].concat(debug ? [] : [
